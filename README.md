...
Version 2.9.0 disables HydroShift II OLED Curve 8.2" device support across the editor UI, device selection dropdowns, hardware detection, gallery filters, local theme filters, and settings.
