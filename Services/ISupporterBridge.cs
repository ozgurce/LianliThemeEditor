...
public interface ISupporterBridge
{
    ...
    Task<IReadOnlyList<GraphStyleOption>> ListGraphStylesAsync(string deviceModel = "", string templatePath = "", CancellationToken cancellationToken = default);
    ...
    Task<string> RenderThemeCanvasAsync(string deviceModel, string templatePath, string outputPath, int canvasWidth, int canvasHeight, string backgroundPath = "", bool noBackground = false, bool skipGraphAnimation = false, string previewDataPath = "", CancellationToken cancellationToken = default);
    ...
    Task<string> SetBackgroundRefsAsync(string deviceModel, string templatePath, string mediaPath, int canvasWidth = 480, int canvasHeight = 480, bool landscape = false, CancellationToken cancellationToken = default);
    ...
    Task RemoveLayersAsync(string deviceModel, string templatePath, IEnumerable<string> layerIndexes, CancellationToken cancellationToken = default);
